...
const perks = [
  ...
  },
  {
    ...
    icon: Leaf,
    description:
      "we've pledge 1% of sales to the restoration and preservation of the planet",
  },
];
  ...
  return (
    <>
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            Your Marketplace for high-qulaity{" "}
      ...
      <section className="border-t border-gray-200 bg-gray-50">
        <MaxWidthWrapper className="py-20 px-3.5 md:px-20 ">
